...
class Spreadsheet_Excel_Writer_Worksheet extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    ...
    /**
    * Array as loopup table containing format information for columns
    * where the index col as the key
    * @var array
    */
    var $_colinfo_lookup;
    ...
    */
    ...
    { // added by Dan Lynn <dan@spiderweblabs.com) on 2006-12-06
        ...
        $this->_colinfo_lookup = array();
        foreach( $this->_colinfo as $key => $colinfo )
            $this->_colinfo_lookup[$colinfo[0]] = &$colinfo[3];
    ...
    */
    function write($row, $col, $token, $format = null)
    {
        if ( is_null( $format ) )
        {
            if ( isset( $this->_colinfo_lookup[$col]) )
            {
                $format = $this->_colinfo_lookup[$col];
            }
        }
